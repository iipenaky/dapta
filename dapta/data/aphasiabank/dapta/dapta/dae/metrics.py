...
Metrics
-------
1. CIU Rate  — Correct Information Units per minute (Nicholas & Brookshire, 1993)
2. MC Score  — Main Concept completeness [0, 1]  (Richardson & Dalton, 2020)
3. MLU-m     — Mean Length of Utterance in morphemes
4. TTR        — Type-Token Ratio (lexical diversity)
5. SynComp   — Syntactic complexity (subordinate clause ratio)

All metrics are validated against CLAN/EVAL reference output in run_dae.py.

References
----------
Nicholas & Brookshire (1993). JSLHR, 36(2), 338–350.
Richardson & Dalton (2020). Aphasiology, 34(1), 16–53.
Fromm, Forbes & MacWhinney (2020). Seminars in Speech & Language, 41(1), 10–19.
Stark et al. (2021). AJSLP, 30(1S), 491–502.
"""
...
try:
    import spacy
    _nlp: Optional[spacy.Language] = None  # Lazy-loaded
...
# Based on Richardson & Dalton (2020) published MC checklists for AphasiaBank
# ---------------------------------------------------------------------------
